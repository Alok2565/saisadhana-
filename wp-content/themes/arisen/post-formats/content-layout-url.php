<?php
	...
	*/
	...
	if(is_home()){ // if blog list page
		...
		if(isset($_GET['blog_list_layout'])) {
			if($_GET['blog_list_layout'] == '2-col-grid'){ //2 Column
			...
			else if($_GET['blog_list_layout'] == '3-col-grid'){ //3 Column
			...
			else if($_GET['blog_list_layout'] == '3-col-masonry'){ //3 Column	masonry
			...
			else if($_GET['blog_list_layout'] == 'sidebar-left'){
				$arisen_blog_type = '1-col';
				$arisen_num_column = 1;
				$arisen_blogsbar = 'col-md-8 sidebar-left'; //left sidebar
				$arisen_sbar = '';
			}
			else if($_GET['blog_list_layout'] == 'sidebar-right'){
				$arisen_blog_type = '1-col';
				$arisen_num_column = 1;
				$arisen_blogsbar = 'col-md-8 sidebar-right'; //right sidebar
				$arisen_sbar = '';
			}
			else if($_GET['blog_list_layout'] == 'no-sidebar'){ //without sidebar, full-width
				$arisen_blog_type = '1-col';
				$arisen_num_column = 1;
		...
		*/
		...
		if(isset($_GET['blog_sidebar'])) {
			if($_GET['blog_sidebar'] == 'sidebar-left') {
				$arisen_psbar = 'col-md-8 sidebar-left'; //left sidebar
				$arisen_sbar = '';
			}
			else if($_GET['blog_sidebar'] == 'sidebar-right'){
				$arisen_psbar = 'col-md-8 sidebar-right'; //default right sidebar
				$arisen_sbar = '';
			}
			else if($_GET['blog_sidebar'] == 'no-sidebar'){
